...
function Highlight({ title, subtitle, buttonText }) {
  ...
  return (
    // Seção de destaque
    <section ref={sectionRef} className='flex min-h-[50svh] w-full items-center justify-center backdrop-blur-md'>
      ...
      >
        ...
        {/* Subtítulo */}
        <p className='mb-4 w-full text-base md:w-9/12 md:text-2xl'>{subtitle}</p>
